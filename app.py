...
# ----------------------------------------------------------------
# TAB 1: DAILY DEFAULTER ANALYSIS (ORIGINAL CODE - NO CHANGES)
# ----------------------------------------------------------------
with tab1:
...
# ----------------------------------------------------------------
# TAB 2: CONSOLIDATED REPORTING SUMMARY (MODIFIED FOR FLAT CSV EXPORT)
# ----------------------------------------------------------------
with tab2:
