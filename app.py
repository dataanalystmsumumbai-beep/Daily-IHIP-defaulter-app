...
report_datetime = st.text_input("Enter Full Date-Time", "Monday 13-04-2026")
...
if dfs:
    ...
    if staff_input:
        ...
        merged["Assigned Staff"] = staff * (len(merged)//len(staff)+1)
        merged["Assigned Staff"] = merged["Assigned Staff"][:len(merged)]
    else:
